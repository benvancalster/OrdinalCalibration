...
bootolr <- function(dataset,outc,modelformula,seedval,bootnum,appres,ncat){
  ...
  for (i in 1:bootnum){  
    train_data <- dataset[sample(row.names(dataset),replace=TRUE),]
    # do the modeling
    mb <- vglm(modelformula, family=cumulative(parallel=T, reverse=T), data=train_data)
    ...
    if(ncat==3){
      mrecalib <- coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,1], family=cumulative(parallel=T, reverse=T)))[1]
      mrecalio <- coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,1], family=cumulative(parallel=T, reverse=T)))[1]
      mrecalsb <- coefficients(vglm(train_data[,outc] ~ mlpredb[,1], family=cumulative(parallel=T, reverse=T)))[c(3)]
      mrecalso <- coefficients(vglm(dataset[,outc] ~ mlpredo[,1], family=cumulative(parallel=T, reverse=T)))[c(3)]
      mrecalib=c(mrecalib, coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,2], family=cumulative(parallel=T, reverse=T)))[2])
      mrecalio=c(mrecalio, coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,2], family=cumulative(parallel=T, reverse=T)))[2])
      mrecalsb=c(mrecalsb, coefficients(vglm(train_data[,outc] ~ mlpredb[,2], family=cumulative(parallel=T, reverse=T)))[c(3)])
      mrecalso=c(mrecalso, coefficients(vglm(dataset[,outc] ~ mlpredo[,2], family=cumulative(parallel=T, reverse=T)))[c(3)])
    }
    if(ncat==4){
      mrecalib <- coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,1], family=cumulative(parallel=T, reverse=T)))[1]
      mrecalio <- coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,1], family=cumulative(parallel=T, reverse=T)))[1]
      mrecalsb <- coefficients(vglm(train_data[,outc] ~ mlpredb[,1], family=cumulative(parallel=T, reverse=T)))[c(4)]
      mrecalso <- coefficients(vglm(dataset[,outc] ~ mlpredo[,1], family=cumulative(parallel=T, reverse=T)))[c(4)]
      mrecalib=c(mrecalib, coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,2], family=cumulative(parallel=T, reverse=T)))[2])
      mrecalio=c(mrecalio, coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,2], family=cumulative(parallel=T, reverse=T)))[2])
      mrecalsb=c(mrecalsb, coefficients(vglm(train_data[,outc] ~ mlpredb[,2], family=cumulative(parallel=T, reverse=T)))[c(4)])
      mrecalso=c(mrecalso, coefficients(vglm(dataset[,outc] ~ mlpredo[,2], family=cumulative(parallel=T, reverse=T)))[c(4)])
      mrecalib=c(mrecalib, coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,3], family=cumulative(parallel=T, reverse=T)))[3])
      mrecalio=c(mrecalio, coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,3], family=cumulative(parallel=T, reverse=T)))[3])
      mrecalsb=c(mrecalsb, coefficients(vglm(train_data[,outc] ~ mlpredb[,3], family=cumulative(parallel=T, reverse=T)))[c(4)])
      mrecalso=c(mrecalso, coefficients(vglm(dataset[,outc] ~ mlpredo[,3], family=cumulative(parallel=T, reverse=T)))[c(4)])
    }
    if(ncat==5){
      mrecalib <- coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,1], family=cumulative(parallel=T, reverse=T)))[1]
      mrecalio <- coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,1], family=cumulative(parallel=T, reverse=T)))[1]
      mrecalsb <- coefficients(vglm(train_data[,outc] ~ mlpredb[,1], family=cumulative(parallel=T, reverse=T)))[c(5)]
      mrecalso <- coefficients(vglm(dataset[,outc] ~ mlpredo[,1], family=cumulative(parallel=T, reverse=T)))[c(5)]
      mrecalib=c(mrecalib, coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,2], family=cumulative(parallel=T, reverse=T)))[2])
      mrecalio=c(mrecalio, coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,2], family=cumulative(parallel=T, reverse=T)))[2])
      mrecalsb=c(mrecalsb, coefficients(vglm(train_data[,outc] ~ mlpredb[,2], family=cumulative(parallel=T, reverse=T)))[c(5)])
      mrecalso=c(mrecalso, coefficients(vglm(dataset[,outc] ~ mlpredo[,2], family=cumulative(parallel=T, reverse=T)))[c(5)])
      mrecalib=c(mrecalib, coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,3], family=cumulative(parallel=T, reverse=T)))[3])
      mrecalio=c(mrecalio, coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,3], family=cumulative(parallel=T, reverse=T)))[3])
      mrecalsb=c(mrecalsb, coefficients(vglm(train_data[,outc] ~ mlpredb[,3], family=cumulative(parallel=T, reverse=T)))[c(5)])
      mrecalso=c(mrecalso, coefficients(vglm(dataset[,outc] ~ mlpredo[,3], family=cumulative(parallel=T, reverse=T)))[c(5)])
      mrecalib=c(mrecalib, coefficients(vglm(train_data[,outc] ~ 1, offset = mlpredb[,4], family=cumulative(parallel=T, reverse=T)))[4])
      mrecalio=c(mrecalio, coefficients(vglm(dataset[,outc] ~ 1, offset = mlpredo[,4], family=cumulative(parallel=T, reverse=T)))[4])
      mrecalsb=c(mrecalsb, coefficients(vglm(train_data[,outc] ~ mlpredb[,4], family=cumulative(parallel=T, reverse=T)))[c(5)])
      mrecalso=c(mrecalso, coefficients(vglm(dataset[,outc] ~ mlpredo[,4], family=cumulative(parallel=T, reverse=T)))[c(5)])
    }
