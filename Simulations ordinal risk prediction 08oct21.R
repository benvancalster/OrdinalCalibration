...

{
  ...
  comsave(filep1="Ordinal prediction model simulations\\ordsimk3p4_nonequi_unequal_moderateorc_noise.RData")
  vgamsmps4a = vgam(datapo[[1]]$y ~ sm.ps(log(acnpres[[3]][,2]/acnpres[[3]][,1]),df=4) + sm.ps(log(acnpres[[3]][,3]/acnpres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  vgamsmps4b = vgam(datapo[[1]]$y ~ sm.ps(log(olrres[[3]][,2]/olrres[[3]][,1]),df=4) + sm.ps(log(olrres[[3]][,3]/olrres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  vgamsmps4c = vgam(datapo[[1]]$y ~ sm.ps(log(acpres[[3]][,2]/acpres[[3]][,1]),df=4) + sm.ps(log(acpres[[3]][,3]/acpres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  vgamsmps4d = vgam(datapo[[1]]$y ~ sm.ps(log(smres[[3]][,2]/smres[[3]][,1]),df=4) + sm.ps(log(smres[[3]][,3]/smres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  plotsave(filep2="Ordinal prediction model simulations\\ordsimk3p4_nonequi_unequal_moderateorc_noise.pdf")
...
load("Ordinal prediction model simulations\\MLR truth Scenario 11\\ordsimk3p4_nonequi_unequal_moderateorc_noise.rdata")
...

{
  ...
  acpres=acpfunc(datafit=datanoise,dataval=datanoise,ECI="nonpar",levels=3,modelformula=y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8)
  smres=smfunc(datafit=datanoise,dataval=datanoise,ECI="nonpar",levels=3,modelformula=y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8)
  comsave(filep1="Ordinal prediction model simulations\\ordsimk3p4_equi_equal_moderateorc_noise_PO.RData")
  vgamsmps4a = vgam(datapo[[1]]$y ~ sm.ps(log(acnpres[[3]][,2]/acnpres[[3]][,1]),df=4) + sm.ps(log(acnpres[[3]][,3]/acnpres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  vgamsmps4b = vgam(datapo[[1]]$y ~ sm.ps(log(olrres[[3]][,2]/olrres[[3]][,1]),df=4) + sm.ps(log(olrres[[3]][,3]/olrres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  vgamsmps4c = vgam(datapo[[1]]$y ~ sm.ps(log(acpres[[3]][,2]/acpres[[3]][,1]),df=4) + sm.ps(log(acpres[[3]][,3]/acpres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  vgamsmps4d = vgam(datapo[[1]]$y ~ sm.ps(log(smres[[3]][,2]/smres[[3]][,1]),df=4) + sm.ps(log(smres[[3]][,3]/smres[[3]][,1]),df=4),family=multinomial(refLevel = 1))
  plotsave(filep2="Ordinal prediction model simulations\\ordsimk3p4_equi_equal_moderateorc_noise_PO.pdf")
...
load("Ordinal prediction model simulations\\CLPO truth Scenario 9\\ordsimk3p4_equi_equal_moderateorc_noise_PO.rdata")
